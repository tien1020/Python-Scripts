...
if sys.argv[1] =="help":
    print("There is a list of CS courses; however, some courses cannot take to gether. Enter `python final_project.py cscourses.txt constraints.txt` in the command line to run the program. The program will ask you enter a number of courses you would like to take and will return the courses that do not conflict each other")

def exception_handler(exception_type, exception, traceback):
    print ("Type to run: `python final_project.py cscourses.txt constraints.txt`" )
